...
using std::ofstream;
using std::string;
KNOB< string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "prova.out", "specify file name");
ofstream TraceFile;
...
int main(int argc, char* argv[])
{
	...
	//Prova
	IMG_AddInstrumentFunction(IMG_HighAddress, 0);
	//Prova
	IMG_AddInstrumentFunction(IMG_LowAddress, 0);
